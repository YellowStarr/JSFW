...
class Person:
    ...
    def Info(self):
        ...
        js="var s=document.getElementsByClassName('form-control'); if s.getAttribute('readonly') return s.value;"
        print dr.execute_script(js)
        ...
        limit=Mytool.findId(dr,"card-front-page")
